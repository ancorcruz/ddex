...
class Net::Ddex::Xml::V20110120::Ddexc::UserDefinedResourceId < Element
  include ROXML


  xml_name "ns5:UserDefinedResourceId"

      xml_accessor :proprietary_ids, :as => [Net::Ddex::Xml::V20110120::Ddexc::ProprietaryId], :from => "ProprietaryId", :required => true
