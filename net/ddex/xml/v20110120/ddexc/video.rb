...
require "net/ddex/xml/v20110120/ddexc/video_details_by_territory"
require "net/ddex/xml/v20110120/ddexc/video_id"
require "net/ddex/xml/v20110120/ddexc/video_type"

module Net module Ddex module Xml module V20110120 module Ddexc  # :nodoc: all

class Net::Ddex::Xml::V20110120::Ddexc::Video < Element
  include ROXML


  xml_name "ns5:Video"

      xml_accessor :video_type, :as => Net::Ddex::Xml::V20110120::Ddexc::VideoType, :from => "VideoType", :required => false
      xml_accessor :artist_related?, :from => "IsArtistRelated", :required => false
      xml_accessor :video_ids, :as => [Net::Ddex::Xml::V20110120::Ddexc::VideoId], :from => "VideoId", :required => false
      xml_accessor :indirect_video_ids, :as => [Net::Ddex::Xml::V20110120::Ddexc::MusicalWorkId], :from => "IndirectVideoId", :required => false
      ...
      xml_accessor :video_details_by_territories, :as => [Net::Ddex::Xml::V20110120::Ddexc::VideoDetailsByTerritory], :from => "VideoDetailsByTerritory", :required => true
