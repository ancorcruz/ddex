...
require "net/ddex/xml/v20100712/ddexc/sound_recording_id"
require "net/ddex/xml/v20100712/ddexc/sound_recording_type"

module Net module Ddex module Xml module V20100712 module Ddexc  # :nodoc: all

class Net::Ddex::Xml::V20100712::Ddexc::SoundRecording < Element
  include ROXML


  xml_name "ns2:SoundRecording"

      xml_accessor :sound_recording_type, :as => Net::Ddex::Xml::V20100712::Ddexc::SoundRecordingType, :from => "SoundRecordingType", :required => false
      xml_accessor :artist_related?, :from => "IsArtistRelated", :required => false
      xml_accessor :sound_recording_ids, :as => [Net::Ddex::Xml::V20100712::Ddexc::SoundRecordingId], :from => "SoundRecordingId", :required => true
      xml_accessor :indirect_sound_recording_ids, :as => [Net::Ddex::Xml::V20100712::Ddexc::MusicalWorkId], :from => "IndirectSoundRecordingId", :required => false
      ...
      xml_accessor :sound_recording_details_by_territories, :as => [Net::Ddex::Xml::V20100712::Ddexc::SoundRecordingDetailsByTerritory], :from => "SoundRecordingDetailsByTerritory", :required => true
