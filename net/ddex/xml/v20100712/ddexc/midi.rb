...
class Net::Ddex::Xml::V20100712::Ddexc::MIDI < Element
  include ROXML
  ...
  xml_name "ns2:MIDI"
      ...
      xml_accessor :midi_details_by_territories, :as => [Net::Ddex::Xml::V20100712::Ddexc::MidiDetailsByTerritory], :from => "MidiDetailsByTerritory", :required => true
