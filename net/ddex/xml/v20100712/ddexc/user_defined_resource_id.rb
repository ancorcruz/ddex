...
class Net::Ddex::Xml::V20100712::Ddexc::UserDefinedResourceId < Element
  include ROXML


  xml_name "ns2:UserDefinedResourceId"

      xml_accessor :proprietary_ids, :as => [Net::Ddex::Xml::V20100712::Ddexc::ProprietaryId], :from => "ProprietaryId", :required => true
