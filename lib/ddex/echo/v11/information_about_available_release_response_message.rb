...
class DDEX::ECHO::V11::InformationAboutAvailableReleaseResponseMessage < DDEX::ECHO::V11::WsAcknowledgement
  include ROXML

    setns "ns4", "http://ddex.net/xml/2011/echo/11"

  xml_name "ns4:InformationAboutAvailableReleaseResponseMessage"

      xml_accessor :ticket_id, :from => "TicketId", :required => true
      xml_accessor :estimated_date_time_of_delivery, :as => Net::Ddex::Xml::V20110120::Ddexc::EventDate, :from => "EstimatedDateTimeOfDelivery", :required => true
