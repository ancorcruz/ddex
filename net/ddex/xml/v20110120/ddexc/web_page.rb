...
class Net::Ddex::Xml::V20110120::Ddexc::WebPage < Element
  include ROXML


  xml_name "ns5:WebPage"

      xml_accessor :page_name, :as => Net::Ddex::Xml::V20110120::Ddexc::Name, :from => "PageName", :required => false
