...
require "net/ddex/xml/v20110120/ddexc/icpn"
...
class Net::Ddex::Xml::V20110120::Ddexc::CollectionId < Element
  include ROXML


  xml_name "ns5:CollectionId"
      ...
      xml_accessor :icpn, :as => Net::Ddex::Xml::V20110120::Ddexc::ICPN, :from => "ICPN", :required => false
